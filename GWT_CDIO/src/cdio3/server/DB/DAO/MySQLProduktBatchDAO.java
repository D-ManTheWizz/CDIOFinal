...
import cdio3.server.DB.Interfaces.ProduktBatchDAO;
...
public class MySQLProduktBatchDAO implements ProduktBatchDAO {
	...
	public ProduktBatchDTO getProduktBatch(int pbId) throws DALException {
	    ...
	    try {
	    	...
	    	return new ProduktBatchDTO (rs.getInt("pb_id"), rs.getInt("recept_id"), rs.getInt("status"), rs.getInt("pro_start"), rs.getInt("pro_slut"));
	    }
	...
	public List<ProduktBatchDTO> getProduktBatchList() throws DALException {
		...
		try
		{
			while (rs.next()) 
			{
				list.add(new ProduktBatchDTO(rs.getInt("pb_id"), rs.getInt("recept_id"), rs.getInt("status"), rs.getInt("pro_start"), rs.getInt("pro_slut")));
			}
		}
		catch (SQLException e) { throw new DALException(e); }
		return list;
